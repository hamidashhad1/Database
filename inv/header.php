...
<nav class="navbar navbar-default navbar-static">
    <div class="navbar-header">
        ...
        <a class="navbar-brand" href="home.php">Database Project</a>
    </div>
        ...
        <div >
            <ul class="nav navbar-nav">
                <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Sales <b class="caret"></b></a>
                    <ul class="dropdown-menu">
                        <li><a href="monthly.php"><i class="icon-cog"></i>Monthly</a></li>
                        <li><a href="perItem.php"><i class="icon-envelope"></i>Per Item Sales</a></li>
                    </ul>
                </li>
            </ul>
        </div>
            ...
            <ul class="nav pull-right">
                <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Welcome, User <b class="caret"></b></a>
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="csprt.php"><i class="icon-envelope"></i> Contact Us</a></li>
                        <li class="divider"></li>
                        <li><a href="include/logout.php"><i class="icon-off"></i> Logout</a></li>
                    </ul>
                </li>
            </ul>
        </div>
